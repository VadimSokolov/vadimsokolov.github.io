...
salary = read.csv("http://vsokolov.org/courses/41000/data/NFLsalary.csv", header = TRUE) 

# attach the dataset 
attach(salary)

# Plot a boxplot to compare salaries of the NFC to AFC.
plot(Conf, Salary, main="Team Salary by Conference", 
     xlab="Conference", ylab="Salary ($1,000s)")
