...
plot(newfood$price,newfood$income, pch=16)
plot(log(newfood$price),log(newfood$income), pch=16)

plot(newfood$price,newfood$svol, pch=16)
plot(log(newfood$price),log(newfood$svol), pch=16)
