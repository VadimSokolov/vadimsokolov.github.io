...
The complete `oj_agent.py` file should be approximately 350-400 lines. If you get stuck, ask Cursor's AI assistant for help by selecting your code and pressing Cmd+K (Mac) or Ctrl+K (Windows), then describing your issue. I also prepared a [complete code reference](oj_agent.py) for you to refer. 
