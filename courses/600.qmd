...
[Canvas HW Submission](https://canvas.gmu.edu/courses/52923/assignments)\
...
#### Optional Textbooks
- Diez, Barr and Cetinkaya-Rundel [OpenIntro Statistics](https://www.openintro.org/stat/textbook.php?stat_book##os), OpenIntro, 2015
- James, Witten, Hastie and Tibshirani, [An Introduction to Statistical Learning with Applications inR](http://www-bcf.usc.edu/~gareth/ISL/index.html), Springer, 2009.
- Kuhn and Johnson, [Applied Predictive Modeling](http://appliedpredictivemodeling.com/), Springer, 2013.
- Hyndman and Athanasopoulos, [Forecasting: Principles and Practice](https://www.otexts.org/fpp), OTexts, 2013.
