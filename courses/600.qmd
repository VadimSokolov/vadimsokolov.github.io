...
[Textbook](https://vsokolov.org/html/_book/). [Week 1 slides](files/600/01-intro.html). [Lab 1](files/600/lab1.html). [Tutor instructions](files/600/tutor-instructions.md). [Course context](files/600/course-context.md). [Tutor setup](#course-tutor). Submit work on [Canvas](https://canvas.gmu.edu).
:::
...
| 2 | 2 Sep | Distributions, Bayes, correlation | [Lab 1](files/600/lab1.html) due |
