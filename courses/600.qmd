...
[Textbook](https://vsokolov.org/html/_book/). [Slides](#slides). [Midterm prep](files/600/midterm-prep.html). [Math background](files/600/math-background.ipynb). [Tutor setup](#course-tutor). Submit work on [Canvas](https://canvas.gmu.edu).
:::
...
| Credits | 3 |
| Recommended preparation | Calculus, probability, statistics, and some programming. If the calculus or matrices for OLS, MLE, and SGD are rusty, use the [math background notebook](files/600/math-background.ipynb). |
...
| Wk | Date | Topic | Work |
|---:|------|-------|------|
| 1 | 26 Aug | Probability; AI/ML landscape | Tutor; [Lab 1](files/600/lab1.html) assigned |
...
| 4 | 16 Sep | MLE, likelihood, CLT | [Lab 3](files/600/lab3.ipynb) due; [Lab 4](files/600/lab4.ipynb) assigned |
| 5 | 23 Sep | OLS, residuals | [Lab 4](files/600/lab4.ipynb) due; [Lab 5](files/600/lab5.ipynb) assigned |
| 6 | 30 Sep | Transforms; logistic regression; classification | [Lab 5](files/600/lab5.ipynb) due; [Lab 6](files/600/lab6.ipynb) assigned |
| 7 | 7 Oct | Testing, predictive values, expected value | [Lab 6](files/600/lab6.ipynb) due |
| 8 | 14 Oct | Midterm | Lab 7; Midterm (2.5 hr); [prep](files/600/midterm-prep.html) |
...
A deck can cover more than one week.

- [Foundations](files/600/01-intro.html)
- [Estimation and regression](files/600/02-estimation-regression.html)
- [Supervised learning](files/600/03-patterns.html)
- [Decisions and Bayes](files/600/04-decisions.html)
- [Model selection](files/600/05-model-selection.html)
- [Deep learning](files/600/06-deep-learning.html)

[Midterm prep / problem bank](files/600/midterm-prep.html). Weeks 1--6 are up; week 7 will be added after 7 October. That page also lists the book sections to read.
...
2. Disclose what you used and for what. No penalty attaches to the disclosure. A studio page: one line. Each decision-log entry: one line. A team that used an assistant for everything and can defend all of it gets full marks.
...
Midterm. Week 8, the whole class, 2.5 hours, pen and paper. One double-sided cheat sheet, printed or handwritten. A calculator is fine. No AI assistant, and no laptop, phone, or watch. The [problem bank](files/600/midterm-prep.html) is posted. It covers weeks 1 through 7 (week 7 will be added after that lecture). This is 40\% of the course: 25 Understanding, 15 Judgment. The 0--3 scale is applied to the scored problems and then scaled to 100.
...
## Computing
You may use R or Python. Install one in week 1. The notes are mostly R; Module 6 includes some Python. Use the language you will defend. Also set up git (a course folder with `notes` and `finalproject` tracked), markdown, Jupyter, and the course tutor. Lab 1 is that setup plus the first probability; submit a Jupyter notebook on Canvas. From Lab 2 the assignment is the notebook. If OLS, MLE, or gradient descent will be new as calculus or matrices, work [math-background.ipynb](files/600/math-background.ipynb) before week 4. Start noticing datasets you have access to through work, research, or an organisation you are part of. Teams lock at the start of week 9, and the proposal is due week 10.
