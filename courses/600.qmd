...
[Textbook](https://vsokolov.org/html/_book/). [Slides](#slides). [Midterm prep](files/600/midterm-prep.html). [Tutor setup](#course-tutor). Submit work on [Canvas](https://canvas.gmu.edu).
:::
