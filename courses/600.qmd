...
Weeks 1 through 7. Before class, about 90 minutes on that week's module: read the notes, work the material, and submit the self-check lab. The lab is a short notebook with three or four exercises and one written question. Ask the tutor anything you got stuck on. In class I lecture for 20 to 30 minutes and then stop. You work a problem on your own, then compare with a neighbor. Laptop and AI are allowed. We go through it, then the next block. Four blocks a night. There is no studio and no project yet.
