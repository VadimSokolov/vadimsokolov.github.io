...
[Textbook](https://vsokolov.org/html/_book/). [Week 1 slides](files/600/01-intro.html). [Tutor instructions](files/600/tutor-instructions.md). [Course context](files/600/course-context.md). [Tutor setup](#course-tutor). Submit work on [Canvas](https://canvas.gmu.edu).
:::
...
| Wk | Date | Topic | Work |
|---:|------|-------|------|
| 1 | 26 Aug | [Probability; AI/ML landscape](files/600/01-intro.html) | Tutor |
| 2 | 2 Sep | Distributions, Bayes, correlation | Lab 1 |
...
- Cursor, Claude Code, or a similar coding tool: put both files in your course folder and set `tutor-instructions.md` as the tool's instructions file. Keep `course-context.md` in that folder so the tool can read it.
